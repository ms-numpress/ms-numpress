...
nuget pack MSNumpress.csproj -Verbosity detailed -Prop 'Configuration=Release;author=ms-numpress' -Version $VERSION_NUMBER -MSBuildPath /usr/lib/mono/msbuild/15.0/bin/
