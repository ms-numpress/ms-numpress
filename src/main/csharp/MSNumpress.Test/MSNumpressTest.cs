...
namespace MSNumpress.Test
{
	...
	public class MSNumpressTest
	{
		...
		[Test]
		public void TestEncodeFixedPoint()
		{
		...
		[Test]
		public void TestEncodeDecodeFixedPoint()
		{
		...
		[Test]
		public void TestEncodeDecodeLinearEmpty()
		{
			byte[] encoded = new byte[8];
		...
		[Test]
		public void TestDecodeLinearNice()
		{
			double[] mzs = { 100.0, 200.0, 300.00005, 400.00010 };
		...
		[Test]
		public void TestDecodeLinearWierd()
		{
		...
		[Test]
		public void TestEncodeDecodeLinear()
		{
		...
		[Test]
		public void TestEncodeDecodePic()
		{
			Random random = new Random();
			int n = 1000;
		...
		[Test]
		public void TestEncodeDecodeSlof()
		{
			Random random = new Random();
			int n = 1000;
			double[] ics = new double[n];
		...
		[Test]
		public void TestEncodeDecodeLinear5()
		{
			Random random = new Random();
			int n = 1000;
			double[] mzs = new double[n];
		...
		[Test]
		public void TestEncodeDecodeSlof5()
		{
			Random random = new Random();
			int n = 1000;
			double[] ics = new double[n];
